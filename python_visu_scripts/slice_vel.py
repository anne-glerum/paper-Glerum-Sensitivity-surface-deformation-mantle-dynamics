...
solution00000pvtu.PointArrayStatus = ['velocity', 'C_14', 'viscosity', 'T']
...
velocityLUT.RescaleTransferFunction(0.0, 0.05)
...
#velocityLUT.Annotations = ['0', '0', '0.05', '5', '0.1', '10', '0.15', '15', '0.2', '20', '0.25', '25', '0.3', '30']
velocityLUT.Annotations = ['0', '0', '0.02', '2', '0.04', '4', '0.06', '6', '0.08', '8', '0.10', '10']
...
vertical_slice_gridcsv = CSVReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/python_visu_scripts/disk_grid_eq_6370.csv'])
#vertical_slice_gridcsv = CSVReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/python_visu_scripts/vertical_slice_grid.csv'])
...
#contour1.Isosurfaces = [0.35, 0.40, 0.45, 0.50, 0.55, 0.60]
contour1.Isosurfaces = [0.12, 0.14, 0.16, 0.18, 0.20, 0.22]
#CHANGE
contour1.Isosurfaces = [0.06, 0.07, 0.08, 0.09, 0.10, 0.11]
...
velocityLUTColorBar = GetScalarBar(velocityLUT, renderView1)
velocityLUTColorBar.Position = [0.288, 0.06]
velocityLUTColorBar = GetScalarBar(velocityLUT, renderView1)
velocityLUT.RescaleTransferFunction(0, 0.10)
velocityLUT.RescaleTransferFunction(0, 0.05)
...
contour2Display.ColorArrayName = ['POINTS', 'velocity']
...
contour2.Isosurfaces = [1900, 2000, 1600, 1700, 1800]
...
#generateSurfaceNormals1 = GenerateSurfaceNormals(Input=resampleWithDataset1)
...
#threshold3 = Threshold(Input=resampleWithDataset1)
...
# Properties modified on clip1.ClipgType
clip1.ClipType.Origin = [6371029.5, 111206.7, 3.9e-10]
clip1.ClipType.Normal = [0.015327735, -0.87812535, 0.4781850365]
clip1.ClipType.Offset = -20e3

# create a new 'Slice'
clip2 = Clip(Input=clip1)

# Properties modified on clip1.ClipgType
clip2.ClipType.Origin = [6371029.5, 111206.7, 3.9e-10]
clip2.ClipType.Normal = [-0.015327735, 0.87812535, -0.4781850365]
clip2.ClipType.Offset = -20e3

# create a new 'Threshold'
threshold4 = Threshold(Input=clip2)
#threshold4 = Threshold(Input=slice1)
#threshold4 = Threshold(Input=resampleWithDataset1)
...
threshold4.ThresholdRange = [-0.5, 0.5]
...
print 'Resampling'
#resampleWithDataset1 = ResampleWithDataset(Input=slice1,
resampleWithDataset1 = ResampleWithDataset(Input=threshold4,
    Source=calculator2)
...
glyph2 = Glyph(Input=resampleWithDataset1,
    GlyphType='Arrow')
...
glyph3Display.DiffuseColor = [0.902, 0.545, 0.706] # green
...
lon_min_zoom = -10.43
lon_max_zoom = 7.93 #12.43 
lon_mid_zoom = 1
lat_min_zoom = -20.
lat_max_zoom = 15.5 #20.
lat_mid_zoom = 0.
scale_zoom = 4900000
min_x_zoom = scale_zoom * math.cos(math.radians(lon_min_zoom)) * math.sin(math.radians(90-lat_min_zoom))
min_y_zoom = scale_zoom * math.sin(math.radians(lon_min_zoom)) * math.sin(math.radians(90-lat_min_zoom))
min_z_zoom = scale_zoom * math.cos(math.radians(90-lat_min_zoom))
max_x_zoom = scale_zoom * math.cos(math.radians(lon_max_zoom)) * math.sin(math.radians(90-lat_max_zoom))
max_y_zoom = scale_zoom * math.sin(math.radians(lon_max_zoom)) * math.sin(math.radians(90-lat_max_zoom))
max_z_zoom = scale_zoom * math.cos(math.radians(90-lat_max_zoom))
print min_x_zoom,min_y_zoom,min_z_zoom
print max_x_zoom,max_y_zoom,max_z_zoom
...
viscosityLUTColorBar.Position = [0.288, 0.17]
viscosityLUT.Annotations = [str(annot1), str(point1), str(annot2), str(point2), str(annot3), str(point3), str(annot4), str(point4)]
velocityLUTColorBar = GetScalarBar(velocityLUT, renderView1)
velocityLUTColorBar.Position = [0.288, 0.08]
velocityLUTColorBar = GetScalarBar(velocityLUT, renderView1)
velocityLUT.RescaleTransferFunction(0, 0.10)
velocityLUT.RescaleTransferFunction(0, 0.05)
#velocityLUT.Annotations = ['0', '0', '0.05', '5', '0.1', '10', '0.15', '15', '0.2', '20', '0.25', '25', '0.3', '30']
velocityLUT.Annotations = ['0', '0', '0.02', '2', '0.04', '4', '0.06', '6', '0.08', '8', '0.10', '10']
velocityLUT.Annotations = ['0', '0', '0.01', '1', '0.02', '2', '0.03', '3', '0.04', '4', '0.05', '5']
...
filename_base = "/Users/visu/Glerum/01092016/aspect/EGU/K08_SEMUCB/slices/slice_vel_K08_SEMUCB__"
count = 1
