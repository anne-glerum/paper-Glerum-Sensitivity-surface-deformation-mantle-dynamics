...
# Rescale transfer function
velocityPWF.RescaleTransferFunction(0.0, 0.06)
...
velocityLUT.Annotations = ['0.00', '0', '0.02', '2.0', '0.04', '4.0', '0.06', '6.0']
...
contour1.Isosurfaces = [0.07, 0.08, 0.09, 0.10, 0.11, 0.14, 0.16, 0.18, 0.20, 0.22, 0.24, 0.26, 0.28]
...
# -44.9 3.72 0.1608
# add three times the absolute Nb motion Doubrovine 2012
# -44.9 3.72 0.4824
# Ex = 0.4824 * 1e-6 * PI / 180.0 * cos(3.72) * cos(-44.9) = 5.951279e-09
# Ey = 0.4824 * 1e-6 * PI / 180.0 * cos(3.72) * sin(-44.9) =-5.930541e-09
# Ez = 0.4824 * 1e-6 * PI / 180.0 * sin(3.72)              =5.4626051e-10
calculator7.Function = 'iHat*(velocity_X+(-5.930541e-09*coordsZ-5.4626051e-10*coordsY))+jHat*(velocity_Y+(5.4626051e-10*coordsX-5.951279e-09*coordsZ))+kHat*(velocity_Z+(5.951279e-09*coordsY+5.930541e-09*coordsX))'
...
# Scale from 5mm to 2cm per year
calculator3.Function = 'iHat*vx/0.005*0.04+jHat*vy/0.005*0.04+kHat/0.005*0.04*vz (point_at_-4_-8_6366000_vel 5mm/yr)'
...
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_Nbx4/slices/slice_vel_reg_sphere_zoom_Nbx4_ref_K08_Nbx4__1_new.png',layout=viewLayout1, magnification=2, quality=100)
