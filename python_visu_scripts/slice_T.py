...
solution00000pvtu.PointArrayStatus = ['T']
...
temperatureLUT = GetColorTransferFunction('T')
...
temperatureLUT.EnableOpacityMapping = 1
temperatureLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 0.05, 0.865003, 0.865003, 0.865003, 0.1, 0.705882, 0.0156863, 0.14902]
...
temperatureLUT.AboveRangeColor = [1.0, 1.0, 1.0]
temperatureLUT.NanColor = [1.0, 1.0, 0.0]
temperatureLUT.Discretize = 1
temperatureLUT.NumberOfTableValues = 265
...
temperatureLUT.RescaleTransferFunction(280.0, 3000)

# get opacity transfer function/opacity map for 'temperature'
temperaturePWF = GetOpacityTransferFunction('T')
temperaturePWF.Points = [0.0, 0.699999988079071, 0.5, 0.0, 0.1, 1.0, 0.5, 0.0]
temperaturePWF.AllowDuplicateScalars = 1
temperaturePWF.ScalarRangeInitialized = 1
temperatureLUT.Annotations = ['280', '280', '1000', '1000', '2000', '2000', '3000', '3000']
...
temperatureLUTColorBar.LabelFormat = '%-#6.0f'
...
temperatureLUTColorBar.Position = [100, 0.85]
temperatureLUTColorBar.DrawTickMarks = 0
temperatureLUTColorBar.DrawTickLabels = 0
temperatureLUTColorBar.AddRangeLabels = 0
temperatureLUTColorBar.TitleFontSize = 10
temperatureLUTColorBar.LabelFontSize = 10

temperatureLUTColorBar.Position = [0.288, 0.05]
temperatureLUTColorBar.Position = [0.288, 0.06]
...
contour1.Isosurfaces = [1600, 1800, 2000, 2200]
...
temperatureLUTColorBar.Position = [0.288, 0.08]

# write label
text3 = Text()
text3.Text = 'Temperature [K]'
...
text4Display.Position = [0.1, 0.70]
...
text5Display.Position = [0.15, 0.57]
...
text6Display.Position = [0.2, 0.38]
...
text7Display.Position = [0.2, 0.005]
text7Display.FontSize = 10

filename_base = "/Users/visu/Glerum/01092016/aspect/EGU/K08_notomo/slices/slice_T_K08_notomo__"
count = 1
