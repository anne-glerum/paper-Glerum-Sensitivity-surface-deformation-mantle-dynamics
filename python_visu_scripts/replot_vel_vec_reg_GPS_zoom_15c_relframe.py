...
calculator7 = Calculator(Input=clip1)
...
# create a new 'Slice'
slice1 = Slice(Input=calculator7)
...
ColorBy(slice1Display, ('POINTS', 'Abs_vel'))
slice1Display.SetScalarBarVisibility(renderView1, True)

# get color transfer function/color map for 'velocity'
velocityLUT = GetColorTransferFunction('Abs_vel')

# get opacity transfer function/opacity map for 'velocity'
velocityPWF = GetOpacityTransferFunction('Abs_vel')
...
calculator1.Function = 'sqrt(Abs_vel_X*Abs_vel_X+Abs_vel_Y*Abs_vel_Y+Abs_vel_Z*Abs_vel_Z)'
...
resampleWithDataset1 = ResampleWithDataset(Input=calculator7,
    Source=calculator4)
...
glyph1Display.ColorArrayName = ['POINTS', 'Abs_vel']
...
text2Display.Position = [0.46, 0.90]
...
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_P06_CSloc_freeslip_notomo/slices/slice_vel_reg_sphere_zoom_Nbframe_K08_P06_CSloc_freeslip_notomo__1_new.png',layout=viewLayout1, magnification=1, quality=100)
