...
solution00000pvtu = XMLPartitionedUnstructuredGridReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/K08_Eu_fixed/solution/solution-00000.pvtu'])
...
calculator9.Function = 'iHat*(velocity_X+(-1.24810786e-09*coordsZ-7.9190714e-10*coordsY))+jHat*(velocity_Y+(7.9190714e-10*coordsX-1.56179982e-09*coordsZ))+kHat*(velocity_Z+(1.56179982e-09*coordsY+1.24810786e-09*coordsX))'
...
print "vel diff range ", diff_range
...
diff_range_slice = slice1.PointData.GetArray("diff").GetRange()
print "vel diff range slice ", diff_range_slice
# hide data in view
...
diff_range_mag = calculator1.PointData.GetArray("Vel diff mag").GetRange()
print "vel diff mag range ", diff_range_mag
...
contour1.ContourBy = ['POINTS', 'Vel diff mag']
contour1.Isosurfaces = [0.0035,0.0045, 0.0055,0.0065]
...
# Add map with indicator line
# create a new 'CSV Reader'
point_values0csv = CSVReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/K08_Eu_fixed/point_values.txt'])
...
# Ey = 0.1232 * 1e-6 * PI / 180.0 * cos(21.61) * sin(-38.63) = -1.24810786e-9
# Ez = 0.1232 * 1e-6 * PI / 180.0 * sin(21.61)               =  7.9190714e-10
calculator7.Function = 'iHat*(Vel_1_X+(-1.24810786e-09*coordsZ-7.9190714e-10*coordsY))+jHat*(Vel_1_Y+(7.9190714e-10*coordsX-1.56179982e-09*coordsZ))+kHat*(Vel_1_Z+(1.56179982e-09*coordsY+1.24810786e-09*coordsX))'
...
# 5 times as much as scale vector 5 mm/yr which represents 1 mm/yr
glyph2.ScaleFactor = 150000000.0
...
glyph2Display.DiffuseColor = [1., 1.0, 0.0]
...
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_Eu_fixed/slices/slice_diffvel_reg_sphere_zoom_K08_Eu_fixed__1_new.png',
