...
clip1.ClipType.Radius = 6362000.0
...
# Properties modified on calculator1
calculator4.ResultArrayName = 'model_points'
...
# Rescale GPS points to lie below model vel points
# create a new 'Calculator'
...
calculator7 = Calculator(Input=calculator8)
...
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_P06_CSloc/slices/slice_vel_reg_sphere_zoom_GPS_P06_CSloc_ref_K08_P06_CSloc__1_new.png',layout=viewLayout1, magnification=2, quality=100)
