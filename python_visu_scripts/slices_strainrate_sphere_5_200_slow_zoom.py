...
solution00000pvtu.PointArrayStatus = ['velocity','strain_rate']
...
diffLUT.RescaleTransferFunction(1e-16, 1e-13)
...
diffLUT.RescaleTransferFunction(1e-16, 1e-13)
# save screenshot
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_Nbx4/slices/slice_strainrate_sphere_K08_Nbx4_zoom__1.png',layout=viewLayout1, magnification=2, quality=100)

# Loop over all the other slices, changing only the necessary settings

filename_base = "/Users/visu/Glerum/01092016/aspect/EGU/K08_Nbx4/slices/slice_strainrate_sphere_K08_Nbx4_zoom__"
count = 1
#count = 4
