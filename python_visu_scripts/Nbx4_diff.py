...
# remove thrice the absolute Nb motion Doubrovine 2012
# -44.9 3.72 -0.4824
# Ex = -0.4824 * 1e-6 * PI / 180.0 * cos(3.72) * cos(-44.9) =-5.951279184e-09
# Ey = -0.4824 * 1e-6 * PI / 180.0 * cos(3.72) * sin(-44.9) = 5.93055e-09
# Ez = -0.4824 * 1e-6 * PI / 180.0 * sin(3.72)              =-5.46261e-10
calculator9.Function = 'iHat*(velocity_X+(5.93055e-09*coordsZ+5.46261e-10*coordsY))+jHat*(velocity_Y+(-5.46261e-10*coordsX+5.951279184e-09*coordsZ))+kHat*(velocity_Z+(-5.951279184e-09*coordsY-5.93055e-09*coordsX))'
...
#velocityLUT.Annotations = ['0.00', '0.0', '0.0025', '2.50', '0.005', '5.00']
...
point_values0csv = CSVReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/K08_Nbx4/point_values.txt'])
...
# Ey = -0.4824 * 1e-6 * PI / 180.0 * cos(3.72) * sin(-44.9) = 5.93055e-09
# Ez = -0.4824 * 1e-6 * PI / 180.0 * sin(3.72)              =-5.46261e-10
calculator7.Function = 'iHat*(Vel_1_X+(5.93055e-09*coordsZ+5.46261e-10*coordsY))+jHat*(Vel_1_Y+(-5.46261e-10*coordsX+5.95128e-09*coordsZ))+kHat*(Vel_1_Z+(-5.951279184e-09*coordsY-5.93055e-09*coordsX))'
...
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_Nbx4/slices/slice_diffvel_reg_sphere_zoom_K08_Nbx4__1_new.png',
