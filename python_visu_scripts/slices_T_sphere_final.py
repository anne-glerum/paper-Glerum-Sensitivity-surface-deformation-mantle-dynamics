...
solution00000pvtu.PointArrayStatus = ['T', 'C_14']
...
# create a new 'XML Partitioned Unstructured Grid Reader'
#solution00000pvtu_1 = XMLPartitionedUnstructuredGridReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/adiab_tbl_noslab/solution/solution-00000.pvtu'])
solution00000pvtu_1 = XMLPartitionedUnstructuredGridReader(FileName=['/Users/visu/Glerum/01092016/aspect/EGU/K08_notomo/solution/solution-00000.pvtu'])
...
# for K08_P07_vp
solution00000pvtu_1.PointArrayStatus = ['velocity', 'gravity', 'p', 'T', 'C_1', 'C_2', 'strain_rate', 'density', 'thermal_expansivity', 'specific_heat', 'viscosity', 'shear_heating', 'adiabatic_heating', 'viscosity_ratio', 'nonadiabatic_temperature']

# Properties modified on solution00000pvtu_1
solution00000pvtu_1.PointArrayStatus = ['T']
...
programmableFilter1.Script = "T0=inputs[0].PointData['T']\nT1=inputs[1].PointData['T']\noutput.PointData.append(T0-T1,'diff')"
programmableFilter1.RequestInformationScript = ''
programmableFilter1.RequestUpdateExtentScript = ''
programmableFilter1.PythonPath = ''
...
#diffLUT.RescaleTransferFunction(-250.0, 250.0)
diffLUT.RescaleTransferFunction(-50.0, 50.0)
#diffLUT.Annotations = ['-300.00', '-300', '-200.0', '-200', '-100.0', '-100', '0.0', '0', '100.0', '100', '200.0', '200', '300.0', '300']
#diffLUT.Annotations = ['-250.00', '-250', '-125.0', '-125', '0.0', '0', '125.0', '125', '250.0', '250']
diffLUT.Annotations = ['-50.00', '-50', '-12.5', '-12.5', '0.0', '0', '12.50', '12.5', '50.0', '50']
...
contour1.ContourBy = ['POINTS', 'diff']
contour1.Isosurfaces = [-925.0, -800.0, -675.0, -500.0, -375.0, 375.0, 500.0, 675.0, 800.0, 925.0]
...
# Properties modified on slice1.SliceType
slice2.SliceType.Center = slice1.SliceType.Center
slice2.SliceType.Radius = slice1.SliceType.Radius
...
# set up 4 other splines as the boundaries of the slab box
# set spline coordinates
# need to go from latitude to colatitude
box_lat_bot = -5
box_lat_top = 5
box_lat_mid = (box_lat_bot + box_lat_top) / 2.0
box_lon_min = -5
box_lon_max = 5
box_lb_x = 6371000.0 * math.cos(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_bot))
box_lb_y = 6371000.0 * math.sin(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_bot))
box_lb_z = 6371000.0 * math.cos(math.radians(90-box_lat_bot))
box_l_x = 6371000.0 * math.cos(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_mid))
box_l_y = 6371000.0 * math.sin(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_mid))
box_l_z = 6371000.0 * math.cos(math.radians(90-box_lat_mid))
box_b_x = 6371000.0 * math.sin(math.radians(90-box_lat_bot))
box_b_y = 0.0
box_b_z = 6371000.0 * math.cos(math.radians(90-box_lat_bot))
box_rb_x = 6371000.0 * math.cos(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_bot))
box_rb_y = 6371000.0 * math.sin(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_bot))
box_rb_z = 6371000.0 * math.cos(math.radians(90-box_lat_bot))
box_r_x = 6371000.0 * math.cos(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_mid))
box_r_y = 6371000.0 * math.sin(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_mid))
box_r_z = 6371000.0 * math.cos(math.radians(90-box_lat_mid))
box_lt_x = 6371000.0 * math.cos(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_top))
box_lt_y = 6371000.0 * math.sin(math.radians(box_lon_min)) * math.sin(math.radians(90-box_lat_top))
box_lt_z = 6371000.0 * math.cos(math.radians(90-box_lat_top))
box_rt_x = 6371000.0 * math.cos(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_top))
box_rt_y = 6371000.0 * math.sin(math.radians(box_lon_max)) * math.sin(math.radians(90-box_lat_top))
box_rt_z = 6371000.0 * math.cos(math.radians(90-box_lat_top))
box_t_x = 6371000.0 * math.sin(math.radians(90-box_lat_top))
box_t_y = 0.0
box_t_z = 6371000.0 * math.cos(math.radians(90-box_lat_top))

splineSource6 = SplineSource()
splineSource6.ParametricFunction = 'Spline'
splineSource6.ParametricFunction.Points = [box_lb_x, box_lb_y, box_lb_z, box_b_x, box_b_y, box_b_z, box_rb_x, box_rb_y, box_rb_z]
...
splineSource7.ParametricFunction.Points = [box_rb_x, box_rb_y, box_rb_z, box_r_x, box_r_y, box_r_z, box_rt_x, box_rt_y, box_rt_z]
splineSource7Display = Show(splineSource7, renderView1)
splineSource7Display.DiffuseColor = [0.0, 0.0, 0.0]

splineSource8 = SplineSource()
splineSource8.ParametricFunction = 'Spline'
splineSource8.ParametricFunction.Points = [box_rt_x, box_rt_y, box_rt_z, box_t_x, box_t_y, box_t_z, box_lt_x, box_lt_y, box_lt_z]
splineSource8Display = Show(splineSource8, renderView1)
splineSource8Display.DiffuseColor = [0.0, 0.0, 0.0]

splineSource9 = SplineSource()
splineSource9.ParametricFunction = 'Spline'
splineSource9.ParametricFunction.Points = [box_lt_x, box_lt_y, box_lt_z, box_l_x, box_l_y, box_l_z, box_lb_x, box_lb_y, box_lb_z]
splineSource9Display = Show(splineSource9, renderView1)
splineSource9Display.DiffuseColor = [0.0, 0.0, 0.0]

# set up 4 other splines as the boundaries of the slab box
# set spline coordinates
# need to go from latitude to colatitude
small_box_lat_bot = -4.25
small_box_lat_top = 4.25
small_box_lat_mid = (box_lat_bot + box_lat_top) / 2.0
small_box_lon_min = -4.25
small_box_lon_max = 4.25
small_box_lb_x = 6371000.0 * math.cos(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_bot))
small_box_lb_y = 6371000.0 * math.sin(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_bot))
small_box_lb_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_bot))
small_box_l_x = 6371000.0 * math.cos(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_mid))
small_box_l_y = 6371000.0 * math.sin(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_mid))
small_box_l_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_mid))
small_box_b_x = 6371000.0 * math.sin(math.radians(90-small_box_lat_bot))
small_box_b_y = 0.0
small_box_b_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_bot))
small_box_rb_x = 6371000.0 * math.cos(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_bot))
small_box_rb_y = 6371000.0 * math.sin(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_bot))
small_box_rb_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_bot))
small_box_r_x = 6371000.0 * math.cos(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_mid))
small_box_r_y = 6371000.0 * math.sin(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_mid))
small_box_r_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_mid))
small_box_lt_x = 6371000.0 * math.cos(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_top))
small_box_lt_y = 6371000.0 * math.sin(math.radians(small_box_lon_min)) * math.sin(math.radians(90-small_box_lat_top))
small_box_lt_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_top))
small_box_rt_x = 6371000.0 * math.cos(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_top))
small_box_rt_y = 6371000.0 * math.sin(math.radians(small_box_lon_max)) * math.sin(math.radians(90-small_box_lat_top))
small_box_rt_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_top))
small_box_t_x = 6371000.0 * math.sin(math.radians(90-small_box_lat_top))
small_box_t_y = 0.0
small_box_t_z = 6371000.0 * math.cos(math.radians(90-small_box_lat_top))
splineSource10 = SplineSource()
splineSource10.ParametricFunction = 'Spline'
splineSource10.ParametricFunction.Points = [small_box_lb_x, small_box_lb_y, small_box_lb_z, small_box_b_x, small_box_b_y, small_box_b_z, small_box_rb_x, small_box_rb_y, small_box_rb_z]
splineSource10Display = Show(splineSource10, renderView1)
splineSource10Display.DiffuseColor = [0.0, 0.0, 0.0]

splineSource11 = SplineSource()
splineSource11.ParametricFunction = 'Spline'
splineSource11.ParametricFunction.Points = [small_box_rb_x, small_box_rb_y, small_box_rb_z, small_box_r_x, small_box_r_y, small_box_r_z, small_box_rt_x, small_box_rt_y, small_box_rt_z]
splineSource11Display = Show(splineSource11, renderView1)
splineSource11Display.DiffuseColor = [0.0, 0.0, 0.0]

splineSource12 = SplineSource()
splineSource12.ParametricFunction = 'Spline'
splineSource12.ParametricFunction.Points = [small_box_rt_x, small_box_rt_y, small_box_rt_z, small_box_t_x, small_box_t_y, small_box_t_z, small_box_lt_x, small_box_lt_y, small_box_lt_z]
splineSource12Display = Show(splineSource12, renderView1)
splineSource12Display.DiffuseColor = [0.0, 0.0, 0.0]

splineSource13 = SplineSource()
splineSource13.ParametricFunction = 'Spline'
splineSource13.ParametricFunction.Points = [small_box_lt_x, small_box_lt_y, small_box_lt_z, small_box_l_x, small_box_l_y, small_box_l_z, small_box_lb_x, small_box_lb_y, small_box_lb_z]
splineSource13Display = Show(splineSource13, renderView1)
splineSource13Display.DiffuseColor = [0.0, 0.0, 0.0]
# Properties modified on splineSource7Display
splineSource2Display.LineWidth = 3.0
# create a new 'Line'
line1 = Line()
...
text3Display.Position = [0.47, 0.14]
...
# save screenshot
SaveScreenshot('/Users/visu/Glerum/01092016/aspect/EGU/K08_notomo/slices/slice_dT_sphere_K08_notomo__1.png',layout=viewLayout1, magnification=1, quality=100)
#SaveScreenshot('/Applications/paraview.app/Contents/data/K08_P07/slices/slice_sphere_K08_P07__2.png',layout=viewLayout1, magnification=1, quality=100)

# Loop over all the other slices, changing only the necessary settings

filename_base = "/Users/visu/Glerum/01092016/aspect/EGU/K08_notomo/slices/slice_dT_sphere_K08_notomo__"
...
#    count = count + 4
    ...
    scale = (radius+2e3)/6371000.0
    SetActiveSource(splineSource9)
    splineSource9.ParametricFunction.Points = [box_lt_x*scale, box_lt_y*scale, box_lt_z*scale, box_l_x*scale, box_l_y*scale, box_l_z*scale, box_lb_x*scale, box_lb_y*scale, box_lb_z*scale]
    SetActiveSource(splineSource8)
    splineSource8.ParametricFunction.Points = [box_rt_x*scale, box_rt_y*scale, box_rt_z*scale, box_t_x*scale, box_t_y*scale, box_t_z*scale, box_lt_x*scale, box_lt_y*scale, box_lt_z*scale]
    SetActiveSource(splineSource7)
    splineSource7.ParametricFunction.Points = [box_rb_x*scale, box_rb_y*scale, box_rb_z*scale, box_r_x*scale, box_r_y*scale, box_r_z*scale, box_rt_x*scale, box_rt_y*scale, box_rt_z*scale]
    SetActiveSource(splineSource6)
    splineSource6.ParametricFunction.Points = [box_lb_x*scale, box_lb_y*scale, box_lb_z*scale, box_b_x*scale, box_b_y*scale, box_b_z*scale, box_rb_x*scale, box_rb_y*scale, box_rb_z*scale]
    SetActiveSource(splineSource13)
    splineSource13.ParametricFunction.Points = [small_box_lt_x*scale, small_box_lt_y*scale, small_box_lt_z*scale, small_box_l_x*scale, small_box_l_y*scale, small_box_l_z*scale, small_box_lb_x*scale, small_box_lb_y*scale, small_box_lb_z*scale]
    SetActiveSource(splineSource12)
    splineSource12.ParametricFunction.Points = [small_box_rt_x*scale, small_box_rt_y*scale, small_box_rt_z*scale, small_box_t_x*scale, small_box_t_y*scale, small_box_t_z*scale, small_box_lt_x*scale, small_box_lt_y*scale, small_box_lt_z*scale]
    SetActiveSource(splineSource11)
    splineSource11.ParametricFunction.Points = [small_box_rb_x*scale, small_box_rb_y*scale, small_box_rb_z*scale, small_box_r_x*scale, small_box_r_y*scale, small_box_r_z*scale, small_box_rt_x*scale, small_box_rt_y*scale, small_box_rt_z*scale]
    SetActiveSource(splineSource10)
    splineSource10.ParametricFunction.Points = [small_box_lb_x*scale, small_box_lb_y*scale, small_box_lb_z*scale, small_box_b_x*scale, small_box_b_y*scale, small_box_b_z*scale, small_box_rb_x*scale, small_box_rb_y*scale, small_box_rb_z*scale]
